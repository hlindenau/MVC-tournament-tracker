...
namespace TournamentsProject.Controllers
{
    public class SponsorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,LogoFilename")] Sponsor sponsor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,LogoFilename")] Sponsor sponsor)
        {
            if (ModelState.IsValid)
            {
